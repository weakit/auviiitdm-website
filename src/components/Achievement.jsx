        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              Mayank Navneet Mehta, Subash Mylraj, Vishva Nilesh Bhate <br></br>
              Abstract: This paper describes the design, implementation, and
              testing of control and vision algorithms for an AUV in virtual and
              real environments. Hardware design and the software stack of the
              vec6 underwater vehicle are described in this paper. The paper
              also presents a simulation test-bed, the uwv-simulator, which is
              developed using ROS and Gazebo. A custom arena similar to that
              used in the Singapore AUV Challenge is constructed in the
              simulation environment. The software stack is designed to execute
              higher and abstract algorithms without the trouble of going
              through the lower-level functions.<br></br> Conference: Global
              OCEANS 2021, San Diego – Porto, Sept 20-23, 2021 <br></br>Link to
              the work:
              <a
